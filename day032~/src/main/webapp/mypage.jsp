...
<body>
	...
	<form action="controller.jsp" method="POST">
		...
		<table border="1">
			<tr>
				<td>아이디</td>
				<td><input type="text" name="mid" readonly required value="<%=request.getAttribute("mid")%>"></td>
			</tr>
			<tr>
				<td>이름</td>
				<td><input type="text" name="name" required value="<%=request.getAttribute("name")%>"></td>
			</tr>
			<tr>
