...
public class BoardDAO {
	...
	private static final String SELECT_ALL_TITLE = "SELECT B.BID, B.TITLE, B.WRITER, B.CONTENT, M.NAME FROM BOARD B LEFT JOIN MEMBER M ON B.WRITER=M.MID WHERE TITLE LIKE ? ORDER BY BID DESC";
	private static final String SELECT_ALL_WRITER = "SELECT B.BID, B.TITLE, B.WRITER, B.CONTENT, M.NAME FROM BOARD B LEFT JOIN MEMBER M ON B.WRITER=M.MID WHERE M.NAME LIKE ? ORDER BY BID DESC";
